...
export default function PortfolioBuilder() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-20 px-4 max-w-7xl mx-auto text-center relative">
      ...
      <div className="glass-card rounded-2xl p-10 max-w-lg relative border-glow-premium/20">
        <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-premium/10 border border-premium/20 mb-6 mx-auto">
        ...
        <p className="text-zinc-400 text-sm sm:text-base leading-relaxed mb-6">
          Turn your resume details into a stunning, responsive, shareable web portfolio hosted under a unique link.
        </p>
        ...
        <div className="border border-white/5 bg-white/5 rounded-xl p-4 mb-6 flex items-center justify-between text-left">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-semibold text-zinc-300">Phase 7 Release Target</span>
          </div>
          <span className="text-[10px] font-bold uppercase tracking-wider bg-white/10 px-2 py-0.5 rounded text-zinc-455">
            Coming Soon
          </span>
        </div>
